...
//    public Vagtplan opretVagtplan(Date fra, Date til, ArrayList<Vagtbehov> vbhListe, ArrayList<Medarbejder> medarbejdere) {
//
//        ArrayList<Vagtbehov> vagtbehovsliste = vbhListe;
//
//        String titel = fra + "-" + til;
...
//        } while (dagsIterator!=til);
//        int nyvagtplanID = 2;
//        Vagtplan vagtplan = new Vagtplan(nyvagtplanID, fra, til, titel, vagtliste);
//
//        return vagtplan;
//    }
//
